    ...
    <div className="flex flex-col gap-6 max-w-2xl">
      ...
      <div className="glass-card rounded-xl p-6">
        ...
        <div className="flex flex-col gap-4">
          {[
            { label: "Notifications par email", desc: "Nouveautés et rappels de formation", on: true },
            { label: "Résumé hebdomadaire", desc: "Votre progression chaque semaine", on: false },
          ].map((p) => (
            <div key={p.label} className="flex items-center justify-between gap-4">
              ...
              <span
                className={`w-11 h-6 rounded-full p-0.5 flex ${
                  p.on ? "bg-primary justify-end" : "bg-surface-variant justify-start"
                }`}
              >
